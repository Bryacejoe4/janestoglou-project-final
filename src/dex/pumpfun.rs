...
pub fn associated_bonding_curve(mint: &Pubkey, tok: TokenProgram) -> Pubkey {
    crate::utils::get_ata_with_program(&bonding_curve_pda(mint), mint, &tok.pubkey())
}
...
pub fn build_buy_instruction(
    ...
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new(associated_bonding_curve(mint, tok),                      false),
